...
public class Camera3Pcontroller {
	...
	public Camera3Pcontroller(SceneNode camN, SceneNode targ, Controller gp, InputManager im) {
		cameraN = camN;
		target = targ;
	...
	public Camera3Pcontroller(SceneNode camN, SceneNode targ, Controller kb, Controller m, InputManager im) {
		cameraN = camN;
		target = targ;
	...
	public void movForward (SceneNode target) {target.moveForward(dFriction); }
